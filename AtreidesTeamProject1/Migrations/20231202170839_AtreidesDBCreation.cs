...
{
    /// <inheritdoc />
    public partial class AtreidesDBCreation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNum = table.Column<string>(type: "varchar(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentDesc = table.Column<string>(type: "varchar(255)", nullable: false),
                    IsArchived = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comment = table.Column<string>(type: "varchar(700)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expiry = table.Column<string>(type: "varchar(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeesSales_Employees_EmployeeID1",
                        column: x => x.EmployeeID1,
                        principalTable: "Employees",
                        principalColumn: "EmployeeID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeesSales_Sales_SalesId",
                        column: x => x.SalesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceMessages_Customer_CustomerID",
                        column: x => x.CustomerID,
                        principalTable: "Customer",
                        principalColumn: "CustomerID");
                    table.ForeignKey(
                        name: "FK_ServiceMessages_Employees_EmployeeID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cart_Department_DepartmentID",
                        column: x => x.DepartmentID,
                        principalTable: "Department",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SalesLineId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductID = table.Column<int>(type: "int", nullable: false),
                    ProductNameProductID = table.Column<int>(type: "int", nullable: false),
                    SalesID = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesLines_Products_ProductNameProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeesSales_EmployeeID1",
                table: "EmployeesSales",
                column: "EmployeeID1");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeesSales_SalesId",
                table: "EmployeesSales",
                column: "SalesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesLines_ProductNameProductID",
                table: "SalesLines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceMessages_CustomerID",
                table: "ServiceMessages",
                column: "CustomerID");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceMessages_EmployeeID",
                table: "ServiceMessages",
                column: "EmployeeID");
        }
